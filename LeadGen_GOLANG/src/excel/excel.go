...
type PotLeads struct {
	Col1 string //Lead
	Col2 string //State Abbreviation
}
...
var (
	...
	filledTemplate = "Filled_Template.xlsx"
)
...
func Excel() {
	...
	blobURL := containerURL.NewBlobURL(filledTemplate)
	...
	file, err := os.OpenFile("Lead_Template.xlsx", os.O_WRONLY|os.O_CREATE, 0666)
	if err != nil {
		fmt.Println(err.Error())
	}
